...
먼저 "이 함수는 이렇게 동작해"라고 컴퓨터에게 알려주는 과정입니다.
...
**📝 함수 선언문 (Function Declaration) — 기본 구조**
...
**📝 함수 표현식 (Function Expression) — 기본 구조**

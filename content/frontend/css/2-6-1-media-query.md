...
<table class="wda-mtable">
<thead><tr><th>모바일 퍼스트의 단점</th><th>내용</th></tr></thead>
<tbody>
<tr><td>모바일 성능 저하 우려</td><td>실제로는 반대로 데스크탑 퍼스트에서 모바일이 불필요한 CSS를 먼저 받는 문제가 생긴다</td></tr>
<tr><td>복잡도 증가</td><td>기존 데스크탑 코드베이스를 모바일 퍼스트로 재작성하는 비용이 크다</td></tr>
<tr><td>우선순위 역전</td><td>PC 중심 서비스에서는 데스크탑 스타일이 더 자주 수정된다</td></tr>
<tr><td>유지보수 어려움</td><td>이미 데스크탑 퍼스트로 짜인 대규모 스타일시트를 전환하기 부담스럽다</td></tr>
</tbody>
</table>

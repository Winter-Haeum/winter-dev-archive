...
<div class="wda-callout wda-ci">
  <p>[[3-1-1-why-git|이전 문서]]에서 Git이 왜 필요한지를 봤다면, 이 문서는 Git 내부가 실제로 어떻게 구성돼 있는지를 다룬다.</p>
  <p>Git이 파일을 저장하기까지 거치는 3가지 영역과, 그 영역 사이를 파일이 이동하는 흐름을 이해하는 데 집중한다. 실제 명령어를 손으로 입력하는 실습은 다음 문서인 <strong>3-1-3</strong>에서 이어간다.</p>
</div>
...
## 3. Working Directory — 지금 작업 중인 폴더

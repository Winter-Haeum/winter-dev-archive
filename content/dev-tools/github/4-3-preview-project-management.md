...
<div class="wda-callout wda-ci">
  <p><strong>4-2에서 배운 Pull Request와 코드 리뷰에 이어, 이번에는 "코드만 보고 판단하기 어려운 부분"을 확인하는 방법을 다룹니다.</strong></p>
  <p>코드 리뷰가 코드 자체를 읽고 확인하는 과정이라면, Preview는 실제로 화면을 눈으로 보고 확인하는 과정입니다.</p>
</div>

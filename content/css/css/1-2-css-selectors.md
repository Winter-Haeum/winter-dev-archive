...
[[1-1-css-syntax-and-apply|이전 문서]]에서 CSS를 어디에 어떻게 적용하는지 배웠다면, 이 문서에서는 "선택자 { 속성: 값; }" 구조 중 맨 앞의 선택자 부분을 자세히 다룬다. 선택자는 스타일을 적용할 대상을 정확히 지정하는 역할을 한다.

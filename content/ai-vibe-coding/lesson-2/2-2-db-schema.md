...
<div class="wda-goal" style="position:relative;padding-right:204px;padding-top:16px;">
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/별 아이콘 (3).webp" alt="" style="position:absolute;width:32px;top:6px;right:24px;z-index:2;pointer-events:none;opacity:.60;transform:rotate(12deg);">
  <img src="/images/decoration/꽃 아이콘 (5).webp" alt="" style="position:absolute;width:30px;top:8px;right:66px;z-index:2;pointer-events:none;opacity:.55;transform:rotate(-10deg);">
  <img src="/images/decoration/꽃 아이콘 (10).webp" alt="" style="position:absolute;width:44px;top:4px;left:20px;z-index:2;pointer-events:none;opacity:.65;transform:rotate(-8deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/핀 아이콘 (3).webp" alt="" style="position:absolute;width:28px;top:-10px;left:14px;z-index:2;pointer-events:none;opacity:.62;transform:rotate(-6deg);">
  <img src="/images/decoration/마스킹 테이프 (5).webp" alt="" style="position:absolute;width:108px;top:-10px;right:20px;z-index:1;pointer-events:none;opacity:.82;transform:rotate(4deg);">
</div>
...
<div class="wda-callout wda-cs" style="position:relative;padding-left:196px;padding-top:16px;">
  <img src="/images/character/번뜩.webp" alt="" style="position:absolute;width:144px;top:-26px;left:-8px;z-index:3;pointer-events:none;opacity:.90;transform:rotate(-5deg);">
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/체크 아이콘 (2).webp" alt="" style="position:absolute;width:28px;top:6px;left:26%;z-index:2;pointer-events:none;opacity:.64;transform:rotate(-8deg);">
  <img src="/images/decoration/종이 클립 아이콘 (3).webp" alt="" style="position:absolute;width:26px;top:4px;right:30%;z-index:2;pointer-events:none;opacity:.58;transform:rotate(15deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/반짝이 아이콘 (2).webp" alt="" style="position:absolute;width:36px;top:6px;left:20px;z-index:2;pointer-events:none;opacity:.64;transform:rotate(8deg);">
  <img src="/images/decoration/하트 아이콘 (4).webp" alt="" style="position:absolute;width:28px;top:8px;left:64px;z-index:2;pointer-events:none;opacity:.56;transform:rotate(-14deg);">
</div>

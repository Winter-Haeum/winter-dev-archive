...
<div class="wda-memo" style="position:relative;padding-right:200px;">
  <img src="/images/character/전체흐름.webp" alt="" style="position:absolute;width:150px;top:-20px;right:8px;z-index:3;pointer-events:none;opacity:.90;transform:rotate(-8deg);">
...
<div class="wda-callout wda-ci">
  <span class="wda-clabel">강사 질문</span>"회원가입 화면을 보고 생각해보세요! 가입하려는 사람이 입력하는 정보들을 하나씩 말해보세요."
</div>
...
<div class="wda-callout wda-ci">
  <span class="wda-clabel">강사 질문</span>"게시물 목록을 보고 생각해보세요! 각 게시물에 어떤 정보들이 표시되고 있나요?"
</div>

<div class="wda-steps" style="position:relative;padding-right:230px;">
  <img src="/images/character/잠깐생각해보기.webp" alt="" style="position:absolute;width:180px;top:16px;right:8px;z-index:3;pointer-events:none;opacity:.90;transform:rotate(-8deg);">
...
<div class="wda-callout wda-cs" style="position:relative;padding-right:66px;">
  <img src="/images/decoration/체크 아이콘 (1).webp" alt="" style="position:absolute;width:42px;top:-8px;right:10px;z-index:3;pointer-events:none;opacity:.80;transform:rotate(11deg);">
...
<div class="wda-memo" style="position:relative;padding-top:18px;">
  <img src="/images/decoration/마스킹 테이프 (10).webp" alt="" style="position:absolute;width:116px;top:-10px;right:20px;z-index:4;pointer-events:none;opacity:.83;transform:rotate(-5deg);">
  <span class="wda-memo-label">💡 포인트</span>
  <div class="wda-memo-body">
<code>author_id</code>는 users 테이블의 <code>id</code>와 연결됩니다. 번호로 테이블이 연결되는 방식입니다.
</div></div>
...
<div class="wda-callout wda-ci">
  <span class="wda-clabel">강사 질문</span>"댓글 부분을 보고 생각해보세요! 각 댓글에 어떤 정보들이 보이나요?"
</div>

<div class="wda-steps" style="position:relative;padding-left:196px;">
  <img src="/images/character/코딩 중.webp" alt="" style="position:absolute;width:148px;top:16px;left:6px;z-index:3;pointer-events:none;opacity:.90;transform:rotate(-8deg);">
...
<div class="wda-memo" style="position:relative;padding-right:200px;">
  <img src="/images/character/오!그렇구나.webp" alt="" style="position:absolute;width:150px;top:-20px;right:8px;z-index:3;pointer-events:none;opacity:.90;transform:rotate(-8deg);">

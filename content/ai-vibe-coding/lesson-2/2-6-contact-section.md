...
| # | 논의 주제 | 선택지 |
|---|-----------|--------|
| 1 | 방명록 레이아웃 | 작성 폼이 위에? 아래에? · 목록은 몇 개씩? |
| 2 | 디자인 스타일 | 카드 형태? 리스트 형태? · 색상과 아이콘은? |
| 3 | 사용자 경험 | 작성 완료 후 피드백 방식? · 최신순 vs 오래된 순? |
...
<div class="wda-callout wda-cw" style="position:relative;padding-right:200px;padding-left:22px;padding-top:16px;padding-bottom:18px;">
  <img src="/images/character/코딩 중.webp" alt="" style="position:absolute;width:185px;top:-22px;right:6px;z-index:3;pointer-events:none;opacity:.90;transform:rotate(10deg);">
  <span class="wda-clabel">⚠ 중요</span>
...
<div class="wda-done" style="position:relative;padding-left:152px;padding-right:24px;padding-bottom:22px;text-align:left;">
  <img src="/images/character/빌드 성공.webp" alt="" style="position:absolute;width:142px;top:-18px;left:8px;z-index:3;pointer-events:none;opacity:.92;transform:rotate(-12deg);">
  <div class="wda-done-ico">📬</div>
  <div class="wda-done-ttl">Contact 섹션 완성 준비 완료!</div>
  <div>연락처 정보와 방명록 기능을 갖춘 완전한 Contact 섹션으로 포트폴리오를 완성합니다. 방문자들이 직접 메시지를 남길 수 있는 살아있는 포트폴리오가 완성됩니다!</div>
</div>

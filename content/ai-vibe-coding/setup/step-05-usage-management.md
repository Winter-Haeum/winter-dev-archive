...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/꽃 아이콘 (7).webp" alt="" style="position:absolute;width:50px;top:-20px;left:8%;z-index:2;pointer-events:none;opacity:.64;transform:rotate(-8deg);">
</div>
...
<div class="wda-callout wda-cw">
  <span class="wda-clabel">주의</span>수업 중 제한에 도달하면 일시적으로 Claude Code 사용이 중단될 수 있습니다.
</div>
...
<div class="wda-memo" style="position:relative;padding-right:210px;padding-left:20px;">
  <img src="/images/character/기억해두기.webp" alt="" style="position:absolute;width:192px;top:-46px;right:5px;z-index:3;pointer-events:none;opacity:.90;transform:rotate(5deg);">
...
<div class="wda-done" style="position:relative;padding-right:210px;padding-left:20px;padding-top:14px;">
  <img src="/images/decoration/마스킹 테이프 (7).webp" alt="" style="position:absolute;width:110px;top:-22px;right:24px;z-index:1;pointer-events:none;opacity:.82;transform:rotate(-9deg);">
  <div class="wda-done-ico">🚀</div>
  <div class="wda-done-ttl">사용량 관리 준비 완료!</div>
  <div>이제 수업 중 어떤 상황에서도 중단 없이 Claude Code를 활용할 수 있습니다. 준비된 개발 환경으로 React 개발의 세계를 탐험해보세요!</div>
</div>

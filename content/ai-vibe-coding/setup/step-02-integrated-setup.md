...
1단계에서 개발 환경을 준비했다면, 이 문서는 그 환경에서 AI에게 실제로 작업을 요청하는 방법을 다룹니다.

특히 프로젝트 초기 세팅처럼 여러 단계가 한 번에 이어지는 큰 작업을 요청할 때 어떻게 맥락을 주고 결과를 검토하는지에 집중합니다. GitHub 백업이나 보안 관리는 다음 문서에서 다룹니다.

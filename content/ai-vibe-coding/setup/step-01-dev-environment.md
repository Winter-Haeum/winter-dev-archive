...
이 setup 카테고리는 5개 문서로 이루어져 있으며, 각 문서는 준비 과정의 서로 다른 단계를 다룹니다. 이 문서(1단계)는 그 중 가장 처음, 포트폴리오 프로젝트를 만들기 전 작업 환경을 준비하는 단계입니다.

필요한 도구를 설치하고 정상 동작을 확인하는 데 집중하며, AI에게 작업을 요청하는 방법이나 GitHub 백업, 보안 관리는 이후 문서에서 다룹니다.

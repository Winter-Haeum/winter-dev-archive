...
<div class="wda-goal" style="position:relative;padding-right:198px;padding-left:14px;">
  ...
  <img src="/images/decoration/반짝이 아이콘 (1).webp" alt="" style="position:absolute;width:20px;top:-18px;right:192px;z-index:2;pointer-events:none;opacity:.66;transform:rotate(-16deg);">
  <span class="wda-goal-label">학습 목표</span>Git MCP와 GitHub CLI를 설치하여, AI에게 <strong>"백업해줘"</strong> 한 마디로 GitHub에 프로젝트를 저장할 수 있는 환경을 구축한다.<br>📦 <strong>GitHub CLI 설치</strong> — gh CLI 설치 및 OAuth 인증으로 GitHub 연결<br>🤖 <strong>스킬 파일 등록</strong> — Claude가 GitHub 작업을 자동 수행하도록 설정<br>🚀 <strong>AI 백업 자동화</strong> — "백업해줘" 한 마디로 GitHub에 자동 저장
</div>

<div class="wda-callout wda-cs" style="position:relative;">
  <img src="/images/decoration/꽃 아이콘 (13).webp" alt="" style="position:absolute;width:28px;bottom:-10px;right:14px;z-index:2;pointer-events:none;opacity:.72;transform:rotate(12deg);">
...
<img src="/images/decoration/마스킹 테이프 (2).webp" alt="" style="position:absolute;width:112px;top:-10px;right:10px;z-index:1;pointer-events:none;opacity:.76;transform:rotate(3deg);">
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/별 아이콘 (3).webp" alt="" style="position:absolute;width:34px;top:-14px;left:38%;z-index:2;pointer-events:none;opacity:.72;transform:rotate(15deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/꽃 아이콘 (11).webp" alt="" style="position:absolute;width:28px;top:-12px;left:20%;z-index:2;pointer-events:none;opacity:.66;transform:rotate(-14deg);">
</div>
...
<div class="wda-callout wda-ci" style="position:relative;padding-left:182px;">
  ...
  <img src="/images/decoration/하트 아이콘 (2).webp" alt="" style="position:absolute;width:20px;top:-20px;left:148px;z-index:2;pointer-events:none;opacity:.68;transform:rotate(-22deg);">
...
<div class="wda-memo" style="position:relative;padding-right:158px;">
  ...
  <img src="/images/decoration/별 아이콘 (4).webp" alt="" style="position:absolute;width:38px;bottom:-12px;left:16px;z-index:2;pointer-events:none;opacity:.70;transform:rotate(-18deg);">
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/꽃 아이콘 (6).webp" alt="" style="position:absolute;width:46px;top:-8px;right:22%;z-index:2;pointer-events:none;opacity:.74;transform:rotate(-14deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/하트 아이콘 (5).webp" alt="" style="position:absolute;width:26px;top:-10px;right:30%;z-index:2;pointer-events:none;opacity:.68;transform:rotate(12deg);">
  <img src="/images/decoration/반짝이 아이콘 (6).webp" alt="" style="position:absolute;width:24px;top:-8px;left:26%;z-index:2;pointer-events:none;opacity:.64;transform:rotate(-18deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/꽃 아이콘 (4).webp" alt="" style="position:absolute;width:30px;top:-14px;right:35%;z-index:2;pointer-events:none;opacity:.68;transform:rotate(-12deg);">
  <img src="/images/decoration/반짝이 아이콘 (2).webp" alt="" style="position:absolute;width:26px;top:-22px;left:28%;z-index:2;pointer-events:none;opacity:.65;transform:rotate(8deg);">
</div>

<div class="wda-callout wda-ci"><span class="wda-clabel">스킬 파일이란?</span>Claude가 특정 작업을 수행할 때 참고하는 가이드 문서입니다. <code>.claude/skills/</code> 폴더에 저장해두면, Claude가 GitHub 작업 요청을 받을 때 이 파일을 참조하여 정확한 gh CLI 명령어를 실행합니다.</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/핀 아이콘 (8).webp" alt="" style="position:absolute;width:30px;top:-12px;left:12%;z-index:2;pointer-events:none;opacity:.68;transform:rotate(10deg);">
</div>

---

<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/마스킹 테이프 (7).webp" alt="" style="position:absolute;width:112px;top:-8px;right:14px;z-index:1;pointer-events:none;opacity:.80;transform:rotate(-5deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/꽃 아이콘 (2).webp" alt="" style="position:absolute;width:38px;top:-8px;right:18%;z-index:2;pointer-events:none;opacity:.72;transform:rotate(16deg);">
</div>
...
<div class="wda-callout wda-cw" style="position:relative;padding-right:196px;">
  ...
  <img src="/images/decoration/반짝이 아이콘 (7).webp" alt="" style="position:absolute;width:20px;top:-26px;right:186px;z-index:2;pointer-events:none;opacity:.66;transform:rotate(20deg);">
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/구름 아이콘 (2).webp" alt="" style="position:absolute;width:30px;top:-14px;right:26%;z-index:2;pointer-events:none;opacity:.62;transform:rotate(6deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/반짝이 아이콘 (5).webp" alt="" style="position:absolute;width:28px;top:-12px;left:18%;z-index:2;pointer-events:none;opacity:.64;transform:rotate(-14deg);">
  <img src="/images/decoration/별 아이콘 (8).webp" alt="" style="position:absolute;width:46px;top:-14px;right:4%;z-index:2;pointer-events:none;opacity:.60;transform:rotate(18deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/핀 아이콘 (3).webp" alt="" style="position:absolute;width:42px;top:-12px;right:28%;z-index:2;pointer-events:none;opacity:.70;transform:rotate(-10deg);">
</div>
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/스탬프 아이콘 (3).webp" alt="" style="position:absolute;width:60px;top:-28px;right:3%;z-index:2;pointer-events:none;opacity:.74;transform:rotate(-8deg);">
</div>
...
<div class="wda-done" style="position:relative;padding-top:14px;">
  <img src="/images/decoration/마스킹 테이프 (5).webp" alt="" style="position:absolute;width:112px;top:-10px;left:20px;z-index:4;pointer-events:none;opacity:.84;transform:rotate(-7deg);">
  <img src="/images/decoration/별 아이콘 (9).webp" alt="" style="position:absolute;width:20px;bottom:8px;right:16px;z-index:2;pointer-events:none;opacity:.64;transform:rotate(14deg);">
...
<div style="position:relative;height:0;overflow:visible;margin:0;">
  <img src="/images/decoration/하트 아이콘 (3).webp" alt="" style="position:absolute;width:28px;top:-26px;left:42%;z-index:2;pointer-events:none;opacity:.66;transform:rotate(20deg);">
</div>
...
<div class="wda-memo" style="position:relative;padding-right:174px;">
  ...
  <img src="/images/decoration/마스킹 테이프 (8).webp" alt="" style="position:absolute;width:112px;top:-10px;left:calc(50% - 56px);z-index:1;pointer-events:none;opacity:.78;transform:rotate(6deg);">
  <img src="/images/decoration/하트 아이콘 (7).webp" alt="" style="position:absolute;width:38px;top:-28px;right:166px;z-index:2;pointer-events:none;opacity:.66;transform:rotate(-16deg);">

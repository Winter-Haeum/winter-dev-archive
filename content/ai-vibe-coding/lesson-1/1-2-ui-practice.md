...
이 문서는 코드를 작성하기 전, 포트폴리오 첫 화면에 무엇이 필요한지 기획하는 단계입니다. 실제로 AI에게 화면을 요청하고 만드는 방법은 [[1-3-box-model-flexbox|1-3 문서]]에서 다룹니다. 디자인 시스템이나 색상 체계 같은 세부 디자인은 이 문서에서 깊게 다루지 않습니다.

...
<div class="wda-callout wda-cs" style="position:relative;padding-left:188px;padding-right:18px;padding-top:14px;padding-bottom:14px;">
  <img src="/images/character/복습하기.webp" alt="" style="position:absolute;width:138px;top:-22px;left:8px;z-index:3;pointer-events:none;opacity:.90;transform:rotate(-8deg);">

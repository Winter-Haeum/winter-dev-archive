...
lesson-1~2에서 만든 포트폴리오는 지금까지 데스크톱 화면 기준으로만 확인해 왔습니다. 이 문서군에서는 같은 포트폴리오를 모바일 등 더 작은 화면에서도 보기 좋게 확장하는 방법을 다룹니다.

이 문서는 그 첫걸음으로, 화면 크기가 달라지면 왜 화면 구성도 달라져야 하는지부터 정리합니다.

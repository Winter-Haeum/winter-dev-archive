...
• <strong>자르기/변형 메서드</strong> — slice, splice를 사용하여 배열을 자르거나 중간의 값을 수정하는 등 구조를 조작합니다.<br>

...
### 1) 연결해야 하는 이유 (Controlled Component)
...
### 1) Q1. state를 변경할 때 반드시 사용해야 하는 함수는?
...
### 2) Q2. 이전 state 값을 기반으로 안전하게 업데이트하려면 어떻게 해야 하나요?

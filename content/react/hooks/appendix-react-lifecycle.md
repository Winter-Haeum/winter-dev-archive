...
![Updating 흐름: Props/State 변경 → DOM 업데이트(Re-render) → Cleanup 실행(이전) → Effect 실행(새것)](/images/content/react/appendix-lifecycle/react-appendix-lifecycle-updating-flow.webp)

...
export const categories = [
  {
    ...
    sectionDocs: {
      ...
      CSS: [
        { slug: '1-3-1-css-syntax-and-apply', title: '1-3-1. CSS 문법과 적용 방법', folder: 'css' },
        { slug: '1-3-2-css-selectors', title: '1-3-2 선택자로 원하는 요소 골라내기', folder: 'css' },
        { slug: '1-3-3-colors-and-fonts', title: '1-3-3. 색상과 폰트로 개성 표현하기', folder: 'css' },
        { slug: '1-3-4-box-model', title: '1-3-4 박스 모델 완벽 이해', folder: 'css' },
        { slug: '1-3-5-display-and-position', title: '1-3-5 Display와 Position으로 배치하기', folder: 'css' },
        { slug: '2-1-1-attribute-selectors', title: '2-1-1. 속성 선택자로 정교하게 선택하기', folder: 'css' },
        { slug: '2-1-2-pseudo-classes', title: '2-1-2. 가상 클래스로 상태 다루기', folder: 'css' },
        { slug: '2-1-3-pseudo-elements', title: '2-1-3. 가상 요소로 꾸미기 — 요소 추가하기', folder: 'css' },
        { slug: '2-2-1-flexbox-concepts', title: '2-2-1. Flexbox 개념 이해하기', folder: 'css' },
        { slug: '2-2-2-flex-container-item-properties', title: '2-2-2 Container와 Item속성 활용하기', folder: 'css' },
        { slug: '2-2-3-flexbox-layout-patterns', title: '2-2-3. Flexbox로 다양한 레이아웃 만들기', folder: 'css' },
        { slug: '2-3-1-grid-structure', title: '2-3-1. Grid 구조 이해하기', folder: 'css' },
        { slug: '2-3-2-grid-rows-and-columns', title: '2-3-2. 행과 열로 자유롭게 배치하기', folder: 'css' },
        { slug: '2-3-3-advanced-grid-layouts', title: '2-3-3. Grid로 구현할 수 있는 고급 레이아웃들', folder: 'css' },
        { slug: '2-4-1-position-placement', title: '2-4-1. Position으로 요소 배치하기 (심화)', folder: 'css' },
        { slug: '2-4-2-transform-effects', title: '2-4-2. Transform으로 변형 효과 주기', folder: 'css' },
        { slug: '2-4-3-z-index-stacking', title: '2-4-3. z-index와 쌓임 순서 이해하기', folder: 'css' },
        { slug: '2-5-1-transition-basics', title: '2-5-1. Transition으로 부드러운 전환 효과', folder: 'css' },
        { slug: '2-5-2-animation-keyframes', title: '2-5-2. Animation과 @keyframes로 움직임 표현하기', folder: 'css' },
        { slug: '2-5-3-hover-effects', title: '2-5-3. Hover 효과로 생동감 더하기', folder: 'css' },
        { slug: '2-6-1-media-query', title: '2-6-1. Media Query로 화면 크기 대응하기', folder: 'css' },
        { slug: '2-6-2-device-optimization', title: '2-6-2. 다양한 기기에서 최적화하기', folder: 'css' },
        { slug: '2-6-3-responsive-techniques', title: '2-6-3. 반응형 기법 익히기', folder: 'css' },
      ],
      Layout: [
        { slug: '1-5-1-analyze-webpage-structure', title: '1-5-1 실전 웹페이지 구조 분석하기', folder: 'layout' },
        { slug: '1-5-2-think-in-blocks', title: '1-5-2 블록으로 나누어 생각하기', folder: 'layout' },
      ],
      DevTools: [
